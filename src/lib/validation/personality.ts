...
export const UserPersonalityUpdateSchema = z
  ...
  .refine((data) => {
    ...
    const hasAnyScore =
      ei !== undefined || sn !== undefined || tf !== undefined || pj !== undefined;
    const hasAllScores =
      ei !== undefined && sn !== undefined && tf !== undefined && pj !== undefined;
...
const _PersonPreferenceCreateSchema = z
  .object({
    personId: z.string().uuid("Person ID must be a valid UUID"),
    preferredPersonId: z.string().uuid("Preferred person ID must be a valid UUID"),
...
const _TeamCreateSchema = z
  .object({
    teamFormationRequestId: z.string().uuid("Team formation request ID must be a valid UUID"),
...
type _PartialPersonalityScores = z.infer<typeof _PartialPersonalityScoresSchema>;
...
type _CompletePersonalityData = z.infer<typeof _CompletePersonalityDataSchema>;
...
type _TeamFormationRequestCreate = z.infer<typeof _TeamFormationRequestCreateSchema>;
