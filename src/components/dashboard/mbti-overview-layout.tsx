          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <p className="text-xl text-stone-900 font-semibold">Persebaran MBTI</p>
              </div>
              <Button
                variant="ghost"
                  ...
                  <>
                    ...
                    <div className="flex-1 flex flex-col min-h-0">
                      ...
                      >
                        ...
                        >
                          {PERSONALITY_DESCRIPTIONS[selectedMBTI]?.title || "Unknown Type"}
                        </h1>
                        <p className="text-sm text-black font-normal text-justify whitespace-pre-line">
                          {PERSONALITY_DESCRIPTIONS[selectedMBTI]?.description ||
