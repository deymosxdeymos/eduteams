...
export function StatisticsCards({ statistics = EMPTY_DASHBOARD_STATISTICS }: StatisticsCardsProps) {
  ...
  return (
    <div className="flex gap-4">
      <div className="px-10 py-6 flex-1 bg-blue-100 rounded-3xl">
        ...
        <p className="text-sky-900 text-base font-medium pt-4">{t("totalAssignments")}</p>
      </div>
      <div className="px-10 py-6 flex-1 bg-emerald-100 rounded-3xl">
        <h1 className="text-6xl font-bold text-emerald-700">{totalTeams}</h1>
        <p className="text-emerald-900 text-base font-medium pt-4">{t("totalTeams")}</p>
      </div>
      <div className="px-10 py-6 flex-1 bg-amber-100 rounded-3xl">
        <h2 className="text-xl font-semibold text-amber-900 mb-4">{t("qualityTitle")}</h2>
        <div className="grid grid-cols-3 gap-4 items-end">
          <div className="flex flex-col items-start">
            ...
            <h1 className="text-4xl font-semibold text-amber-700">{formatPercent(min)}</h1>
          </div>
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-1.5 text-amber-900 text-sm font-medium">
              <span>{t("max")}</span>
            ...
            <h1 className="text-4xl font-semibold text-amber-700">{formatPercent(max)}</h1>
          </div>
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-1.5 text-amber-900 text-sm font-medium">
              <span>{t("mean")}</span>
            ...
            <h1 className="text-4xl font-semibold text-amber-700">{formatPercent(mean)}</h1>
          </div>
        </div>
      </div>
    </div>
