  ...
  if (!mbtiType) {
    return (
      <div className="flex flex-col gap-2 self-stretch">
        ...
        >
          <div className={`${colorScheme.primaryText} text-lg font-bold`}>Take Test</div>
        </div>
        <div
    ...
    <div className="flex flex-col gap-2 self-stretch">
      ...
      >
        <Sparkle
          ...
          fill="currentColor"
        />
        <Image src={`/mbti-text/${mbtiType}.svg`} alt={mbtiType} width={150} height={150} />
        <Sparkle
          className={`${colorScheme.primaryText} rounded-md w-14 h-8 py-[1px]`}
          size={12}
          fill="currentColor"
      ...
      <div
        className={`flex items-center justify-center border ${colorScheme.lightBorder} rounded-xl shadow-glow ${colorScheme.lightShadow} p-4 flex-1`}
      >
        <Image src={`/mbti-type/${mbtiType}.svg`} alt={mbtiType} width={150} height={150} />
      </div>
    </div>
  );
}
