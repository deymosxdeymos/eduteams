...
export default function InstructionModal({ isOpen, onCloseAction }: InstructionModalProps) {
          ...
          <div className="mb-8">
            <div className="flex items-start justify-between relative px-4">
              {likertScale.map((item) => (
                <div key={item.icon} className="flex flex-col items-center space-y-3 relative z-10">
