...
export function EmptyStudentClassState({ onClassJoined }: EmptyStudentClassStateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-4 mx-auto h-full">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-semibold text-gray-800 tracking-tight pb-2">{t("title")}</h1>
