          ...
          <div className='mt-4'>
            <div className='relative text-center text-3xl font-semibold w-56 rounded-full bg-white p-4 text-blue-800'>
              ...
              <div className='absolute z-10 right-0'>
                <div className='rounded-sm before:rounded-full before:absolute before:-bottom-10.5 before:-left-17 before:h-14 before:w-8 before:rotate-42 before:transform before:border-r-2 before:border-t-2 before:border-white before:bg-white'></div>
              </div>
            </div>
          </div>
        </div>
