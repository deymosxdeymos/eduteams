...
export function StudentClassGrid({ classes, showNoResults, onClassLeft }: StudentClassGridProps) {
                ...
                >
                  ...
                  <div className="mt-auto space-y-2 pt-1">
                    ...
                    <p className="text-xs font-medium tracking-wide text-gray-500 md:text-sm md:tracking-normal">
                      {t("academicYear", {
                        start: classItem.tahunAwalPeriode,
                        end: classItem.tahunAkhirPeriode,
                      })}
                    </p>
                  </div>
                </div>
        ...
        <DialogContent className="sm:max-w-xs">
          <DialogHeader>
            ...
            <div className="text-left space-y-4">
              <DialogDescription>
                Jika kamu keluar dari kelas ini, kamu tidak akan bisa mengakses tugas, pengumuman,
                atau informasi dari kelas ini lagi.
              </DialogDescription>
