  ...
  return (
    <div className="flex gap-x-16 items-start justify-center">
      <div className="flex flex-col items-center relative">
        <motion.button
          type="button"
          aria-describedby={showDosenInvalid ? `${id}-dosen-email-requirement` : undefined}
          ...
          animate={{
            ...
            backgroundColor: selectedRole === "dosen" ? "rgb(253, 230, 138)" : "rgb(244, 244, 245)",
          }}
          whileHover={
            selectedRole !== "dosen"
              ? {
                  ...
                  scale: 1.02,
                  boxShadow: "0 0 0 2px rgba(251, 191, 36, 0.2), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
                }
              : undefined
          }
          whileTap={{ scale: 0.98 }}
        ...
        {showDosenInvalid && (
          ...
          >
            ...
            <span className="whitespace-nowrap">{t("institutionalEmailRequired")}</span>
          </div>
        )}
      </div>
      <motion.button
        ...
        animate={{
          ...
          backgroundColor:
            selectedRole === "mahasiswa" ? "rgb(187, 247, 208)" : "rgb(244, 244, 245)",
        }}
        whileHover={
          selectedRole !== "mahasiswa"
            ? {
                backgroundColor: "rgb(228, 228, 231)",
                scale: 1.02,
                boxShadow: "0 0 0 2px rgba(134, 239, 172, 0.2), 0 4px 6px -1px rgba(0, 0, 0, 0.1)",
              }
            : undefined
        }
        whileTap={{ scale: 0.98 }}
      ...
      >
        {" "}
        <Image
          src={selectedRole === "mahasiswa" ? "/mahasiswa.svg" : "/mahasiswa-inactive.svg"}
          width={240}
          height={240}
          alt="mahasiswa"
          className="mb-[-20px]"
