...
export function IsfJMascot({ className }: { className?: string }) {
  return (
    ...
    >
      {/* Left leg */}
      <motion.g {...legSwayLeft} style={{ transformOrigin: "131px 215px" }}>
        <path
      ...
      />
      {/* Right leg */}
      <motion.g {...legSwayRight} style={{ transformOrigin: "209px 210px" }}>
        <path
      ...
      <rect
        ...
        width="16.2507"
        height="41.7773"
        transform="rotate(-17.3692 58.4824 177.185)"
        fill="#293056"
      />
      <path
        d="M27.7383 51.6765L48.6561 69.875L75.7685 156.554L61.8999 160.892L27.7383 51.6765Z"
        fill="url(#isfj_paint3)"
      />
      <path
        d="M27.7383 51.6765L20.9189 78.551L48.0313 165.23L61.8999 160.892L27.7383 51.6765Z"
        fill="#EAECF5"
      />
      <path
        d="M89.6357 152.215L93.9737 166.084L67.1854 177.794L61.8985 160.891L89.6357 152.215Z"
        fill="#363F72"
      />
      <path
        d="M34.1621 169.567L38.5001 183.436L67.1863 177.794L61.8993 160.891L34.1621 169.567Z"
        fill="#4E5BA6"
      />
      {/* Left wheel - spin */}
      <motion.g {...spinMedium} style={{ transformOrigin: "57.58px 196px" }}>
        <circle
          cx="57.5756"
          cy="196.001"
          r="16.5"
          transform="rotate(11.5169 57.5756 196.001)"
          fill="black"
        />
      </motion.g>
      {/* Sparkle */}
      <g filter="url(#isfj_filter0)">
        <path
          d="M19 71.0005C27.2104 74.1584 24 71.1584 27.079 68.0005C25.5 74.0005 26.5 73.5005 30.5 76.8426C25.3584 74.1857 22.8002 78.2212 22.116 80.1344C22.0791 80.2542 22.0404 80.3762 22 80.5005C22.0297 80.3908 22.0683 80.2677 22.116 80.1344C23.5807 75.3833 22.3368 74.0807 19 71.0005Z"
          fill="#FDFDFD"
        />
      </g>
      {/* Right wheel group - spin */}
      <motion.g {...spinMedium} style={{ transformOrigin: "270.5px 199.5px" }}>
        <circle cx="278.5" cy="184.5" r="16.5" fill="black" />
      </motion.g>
      {/* Right eye frame */}
      <path
        d="M216.559 81C243.873 81 265.514 102.023 265.514 127.352C265.514 152.68 243.873 173.704 216.559 173.704C189.244 173.704 167.604 152.68 167.604 127.352C167.604 102.023 189.244 81 216.559 81Z"
        stroke="#026AA2"
        strokeWidth="12"
      />
      {/* Cheek highlights */}
      <path
        d="M141.802 173.092C148.432 156.023 167.07 159.885 170.817 165.673C174.564 171.462 174.029 189.977 158.32 196.858C142.611 203.739 114.338 193.995 102.166 188.263C112.579 191.861 135.172 190.161 141.802 173.092Z"
        fill="#FAFAFF"
      />
      <path
        d="M198.955 167.281C189.28 151.588 171.644 158.51 169.023 164.836C166.402 171.162 170.344 189.299 187.078 193.443C203.812 197.587 229.847 183.26 240.773 175.579C231.185 180.865 208.63 182.974 198.955 167.281Z"
        fill="#FAFAFF"
      />
      {/* Antenna */}
      <path
        d="M262 141C265.052 148.19 274.324 159.152 287 145.477"
        stroke="#065986"
        strokeWidth="4"
        strokeLinecap="round"
      />
      ...
      <circle
        ...
        cy="199.5"
        r="38.5"
        transform="rotate(-37.6742 270.5 199.5)"
        fill="#3E4784"
      />
      <circle
        cx="270.499"
        cy="199.5"
        r="32.0833"
        transform="rotate(-37.6742 270.499 199.5)"
        fill="#4E5BA6"
      />
      <path
        d="M289.709 225.195C275.703 235.672 255.833 233.002 245.106 219.109C234.378 205.216 236.821 185.317 250.5 174.417L289.709 225.195Z"
        fill="url(#isfj_paint4)"
      />
      <circle
        cx="270.5"
        cy="199.5"
      ...
      <g filter="url(#isfj_filter1)">
        <path
          d="M280 169C288.21 172.158 285 169.158 288.079 166C286.5 172 287.5 171.5 291.5 174.842C286.358 172.185 283.8 176.221 283.116 178.134C283.079 178.254 283.04 178.376 283 178.5C283.03 178.39 283.068 178.267 283.116 178.134C284.581 173.383 283.337 172.08 280 169Z"
          fill="#FDFDFD"
        />
      </g>
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.8878 0 0 0 0 0.980769 0 0 0 0 0.183894 0 0 0 0.25 0"
          />
