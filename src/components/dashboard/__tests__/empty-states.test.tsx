...
describe("Dashboard empty states", () => {
  it("renders dosen empty state and matches snapshot", () => {
    ...
    expect(screen.getByText("You haven't created any classes yet")).toBeTruthy();
    expect(screen.getByText("Create a class to start team formation")).toBeTruthy();
  });
  ...
  it("renders student empty state and matches snapshot", async () => {
    ...
    expect(
      screen.getByText("Enter the class token provided by your lecturer to join a class"),
    ).toBeTruthy();
