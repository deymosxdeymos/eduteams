...
export function getMBTIColorScheme(mbtiType: MBTIType | null | undefined): ColorScheme {
  if (!mbtiType) {
...
export function getMBTICategory(mbtiType: MBTIType | null | undefined): PersonalityCategory {
  if (!mbtiType) {
    return "diplomats";
  }
