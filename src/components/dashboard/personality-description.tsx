...
export function PersonalityDescription({ user }: PersonalityDescriptionProps) {
  ...
  if (!mbtiType) {
    return (
      ...
      >
        <h1 className={`text-3xl font-bold ${colorScheme.primaryText}`}>Complete Your Test</h1>
        <p className="text-xs text-black font-normal text-justify">
          Complete your personality test to see your detailed personality description and team
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-black font-normal text-justify whitespace-pre-line">
        {personality?.description || "No description available for this personality type."}
      </p>
    </div>
  );
}
